...
[![Coverage Status](https://coveralls.io/repos/RocketChat/Rocket.Chat/badge.svg)](https://businesscrowd.co.uk)
[![Code Climate](https://codeclimate.com/github/RocketChat/Rocket.Chat/badges/gpa.svg)](https://businesscrowd.co.uk)

## Roadmap

#### In Progress
- Wordpress Intergration and customisation  [Issue # 1920](https://github.com/RocketChat/Rocket.Chat/issues/1920)
...
- Anonymous use: [Issue #604](https://github.com/RocketChat/Rocket.Chat/issues/604)
...
If you want to help, send an email to support at Business Crowd to be invited to the translation project.

## Community

Join thousands of members  world-wide 24 x 7 in our [community server](https://businesscrowd.co.uk/pages).  Join the conversation at [Twitter](https://twitter.com/crowdpromote), [Facebook](https://www.facebook.com/businescrowd)

## How to Contribute

Already a JavaScript developer?  
Be invited to beomce a member of Business Crowd's international contributors community.
...
Thanks to our rocket chat team -
