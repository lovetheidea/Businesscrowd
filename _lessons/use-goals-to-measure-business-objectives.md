...
When you set up a Goal in Google Analytics, you may also create a "goal funnel." This is a data visualization showing the several steps required to complete the goal. This chart helps determine where people are abandoning the conversion process. Goals and funnels could be used by eCommerce businesses to determine if users are able to complete a multi-step checkout process. Other businesses could track newsletter sign-ups, contact form completions, page navigations, the number of pages viewed in a session, or time on site.
