...
status: "publish"
course_id: "96510"
original_url: "/lti-content/courses/beginners-guide-to-google-analytics/lesson/tracking-campaigns-with-the-url-builder/"
---

#### **Tracking campaigns with URL Builder**

To access the URL builder in the Help Center, click the link at the end of this lesson and scroll down to the URL builder form.

In the first step, enter the URL of your website (or where you want your ad or campaign link to take users). Then fill out the fields for the campaign, source, and medium. You may fill out the fields for term, content, and name if you like. Term, content, and name can be any values you want; just make sure they're descriptive enough to recognize when they appear in your Google Analytics reports.

![Tracking campaigns with URL Builder](https://r2.businesscrowd.co.uk/wp-content/uploads/2021/10/Tracking-campaigns-with-URL-Builder-300x253.png)
...
![A quick note about naming conventions. ](https://r2.businesscrowd.co.uk/wp-content/uploads/2021/10/A-quick-note-about-naming-conventions.-300x70.png)
...
![quick note about naming conventions.](https://r2.businesscrowd.co.uk/wp-content/uploads/2021/10/WhatsApp-Image-2021-10-14-at-11.59.17-PM-243x300.jpeg)
